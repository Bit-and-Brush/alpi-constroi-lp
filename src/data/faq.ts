...
export const faqItems: Record<"pt" | "en", FAQ[]> = {
  pt: [
    {
      question: "Que Tipos De Obras Realiza A Alpiconstroi?",
      answer:
        "A Alpiconstroi realiza obras residenciais (moradias urbanas e campestres, lazer, desporto), comerciais, industriais (fábricas, escritórios), obras públicas e infraestruturas, bem como trabalhos de requalificação e renovação de espaços existentes, incluindo carpintaria e serralharia.",
    },
    {
      question: "Como Determina A Alpiconstroi O Preço Dos Projectos?",
      answer:
    ...
    {
      question: "Os Técnicos Da Alpiconstroi São Licenciados E Segurados?",
      answer:
    ...
    {
      question: "Com Que Rapidez A Alpiconstroi Responde A Pedidos Urgentes?",
      answer:
  ...
  en: [
    {
      question: "What Types Of Work Does Alpiconstroi Carry Out?",
      answer:
        "Alpiconstroi carries out residential works (urban and rural homes, leisure, sports), commercial, industrial (factories, offices), public works and infrastructure, as well as refurbishment and renovation of existing spaces, including carpentry and metalwork.",
    },
    {
      question: "How Does Alpiconstroi Determine Project Prices?",
      answer:
    ...
    {
      question: "Are Alpiconstroi's Technicians Licensed And Insured?",
      answer:
    ...
    {
      question: "How Quickly Does Alpiconstroi Respond To Urgent Requests?",
      answer:
